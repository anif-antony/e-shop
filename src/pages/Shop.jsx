...
const Shop = () => {
    ...
    return (
      <div className="container mx-auto p-4 mt-20">
        <h1 className="text-3xl font-bold text-center my-6">Shop</h1>
        <div>
          <div className="grid grid-cols-1 sm:grid-cols-2 mt-12 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
